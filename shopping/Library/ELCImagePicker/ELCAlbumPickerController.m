...
{
	[self.tableView reloadData];
	[self.navigationItem setTitle:NSLocalizedString(@"相册选择", nil)];
}
...
//    UIButton *btn = [[UIButton alloc]initWithFrame:CGRectMake(cell.frame.size.width - 30, cell.frame.size.height - 30, 25, 25)];
...
//    self.imageViewController = [[FSImageViewerViewController alloc] initWithImageSource:photoSource imageIndex:indexPath.row];
//
