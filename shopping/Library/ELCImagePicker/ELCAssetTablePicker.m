...
- (void)preparePhotos
{
    @autoreleasepool {
        ...
        dispatch_sync(dispatch_get_main_queue(), ^{
            ...
            [self.navigationItem setTitle:self.singleSelection ? NSLocalizedString(@"图片", nil) : NSLocalizedString(@"图片", nil)];
        });
    }
}
...
{
	return 78 * ([UIScreen mainScreen].bounds.size.width / 320);
}
