...
- (void)setUpImageViewer {
    ...
    CGRect screenFrame = CGRectMake(0,0,CGRectGetWidth([[UIScreen mainScreen]bounds]),CGRectGetHeight([[UIScreen mainScreen]bounds]));
    //__block CGFloat targetY = ((mainImageView.superview.frame.size.height - mainImageViewFrame.size.height) / 2.0f);
    __block CGFloat targetY = ((screenFrame.size.height - mainImageViewFrame.size.height - 64 ) / 2.0f) ;
